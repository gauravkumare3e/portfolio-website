        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing architectures that scale securely and efficiently.
                From provisioning servers to managing cloud resources gracefully.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Automating pipelines and containerizing applications. Building 
                reliable CI/CD workflows and managing resilient systems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
